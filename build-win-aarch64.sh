...
cp native/build-aarch64/src/Release/Stratix.exe build/win-aarch64/
cp target/Stratix.jar build/win-aarch64/
...
echo Stratix.exe aarch64 sha256sum
sha256sum build/win-aarch64/Stratix.exe

dumpbin //HEADERS build/win-aarch64/Stratix.exe
