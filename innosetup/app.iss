...
OutputDir=${basedir}
OutputBaseFilename=StratixSetup

[Tasks]
Name: DesktopIcon; Description: "Create a &desktop icon";

[Files]
Source: "${basedir}\build\win-x64\Stratix.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "${basedir}\build\win-x64\Stratix.jar"; DestDir: "{app}"
