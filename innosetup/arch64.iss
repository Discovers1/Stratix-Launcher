...
OutputDir=${basedir}
OutputBaseFilename=StratixSetupAArch64

[Tasks]
Name: DesktopIcon; Description: "Create a &desktop icon";

[Files]
Source: "${basedir}\build\win-aarch64\Stratix.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "${basedir}\build\win-aarch64\Stratix.jar"; DestDir: "{app}"
