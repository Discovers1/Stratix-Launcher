...
cp native/build-x64/src/Release/Stratix.exe build/win-x64/
cp target/Stratix.jar build/win-x64/
...
echo Stratix.exe 64bit sha256sum
sha256sum build/win-x64/Stratix.exe

dumpbin //HEADERS build/win-x64/Stratix.exe
