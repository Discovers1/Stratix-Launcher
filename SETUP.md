...
configure<BootstrapPluginExtension> {
    ...
    customRepo.set("https://assets.stratix.com/LauncherTest/repo")
...
```kotlin
https://assets.stratix.com/LauncherTest/ClientManifest.json
```
...
[
  {
    ...
    "bootstrap": "https://assets.stratix.com/LauncherTest/bootstrap.json",
    "bootstrapsig": "https://assets.stratix.com/LauncherTest/bootstrap.json.sha256",
...
1) Go into launcher.properties And edit 'stratix' and links to your server links and name
...
runelite.download.link=https://**stratix**.net/download/  
runelite.website=https://**stratix**.net/  
runelite.bootstrap=https://stratix.s3.eu-west-2.amazonaws.com/bootstrap.json  
runelite.bootstrapsig=https://stratix.s3.eu-west-2.amazonaws.com/bootstrap.json.sha256  
runelite.name=**Stratix**  
...
Make sure CC is selected and replace 'Stratix' with 'MyCoolName' MAKE SURE ITS CAPS E same with the server name

3) Inside Intellij click the root of the project and press CTRL + ALT + R

Make sure CC is selected and replace 'stratix' with 'myCoolName' MAKE SURE ITS LOWERCASE E same with the server name
...
Once you have pushed your files to github, github actions will build your launcher you can then find them under the workflow action it runs EG: https://github.com/Stratix-Community/Runelite-Launcher-rsps/actions/runs/3014844052
