...
cp native/build-x86/src/Release/Stratix.exe build/win-x86/
cp target/Stratix.jar build/win-x86/
...
echo Stratix.exe 32bit sha256sum
sha256sum build/win-x86/Stratix.exe

dumpbin //HEADERS build/win-x86/Stratix.exe
